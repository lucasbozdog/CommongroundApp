...
Create a database (for example: commonground).
...
Then insert some test users (optional):
...
Add JavaFX VM options if needed:
...
The project uses a relational schema with foreign key constraints.
