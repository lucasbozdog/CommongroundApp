...
import commonground.controllers.BaseController;
...
public class SceneRouter {
    ...
    public void showRoleSelect() { setScene("/views/RoleSelect.fxml", 420, 260); }
    public void showAdmin()      { setScene("/views/AdminScene.fxml", 900, 600); }
    public void showUser()       { setScene("/views/UserScene.fxml", 900, 600); }
